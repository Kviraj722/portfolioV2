...
const Technologies = () => {
  return (
    <div className="border-1 rounded-md container mt-10 shadow-blurred-border">
      <div className="flex border-2 h-60 flex-col gap-2 overflow-hidden rounded-xl p-4 shadow-feature-card dark:shadow-feature-card-dark lg:p-6">
